...
image_rock2 = ImageTk.PhotoImage(Image.open("rockC.png"))
image_paper2 = ImageTk.PhotoImage(Image.open("paperC.png"))
image_scissor2 = ImageTk.PhotoImage(Image.open("scissorC.png"))
